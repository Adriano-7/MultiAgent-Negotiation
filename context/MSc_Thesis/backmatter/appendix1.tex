...
The placeholder \texttt{[slate block]} is the set of labeled candidate moves; \texttt{[labels]} is the comma-separated list of candidate letters (e.g.\ A, B, C for a three-member team).
